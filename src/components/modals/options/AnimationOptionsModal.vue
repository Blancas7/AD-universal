...
export default {
  ...
  methods: {
    update() {
      ...
      this.rewindUnlocked = this.fullCompletion || progress.isRewindUnlocked;
      // 136 is given upon dilating
      this.dilationUnlocked = this.rewindUnlocked || this.realityUnlocked || Achievement(136).canBeApplied;
      this.tachyonsUnlocked = this.rewindUnlocked || this.realityUnlocked || Currency.tachyonParticles.gt(0);
