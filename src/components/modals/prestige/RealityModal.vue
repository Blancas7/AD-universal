...
export default {
  ...
  computed: {
    ...
    gained() {
      ...
      gainedResources.push(`${quantifyInt("Reality", this.simRealities * player.rewind.celestialMultiplier)}`);
      gainedResources.push(`${quantifyInt("Perk Point", this.simRealities * player.rewind.celestialMultiplier)}`);
