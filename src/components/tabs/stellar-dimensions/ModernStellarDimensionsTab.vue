...
export default {
  ...
  methods: {
    update() {
      ...
      this.galaxyMultiplier = Decimal.log10(Decimal.max(this.stardust.max(1).log10(), 1)).div(20).toNumber();
      this.stardustPerSecond.copyFrom(StellarDimension(1).productionPerSecond);
