...
Currency.antimatter = new class extends DecimalCurrency {
  ...
  set value(value) {
    ...
    player.records.thisRewind.maxAM = player.records.thisRewind.maxAM.max(value);
...
Currency.infinityPoints = new class extends DecimalCurrency {
  ...
  set value(value) {
    ...
    player.records.thisRewind.maxIP = player.records.thisRewind.maxIP.max(value);
...
Currency.eternityPoints = new class extends DecimalCurrency {
  ...
  set value(value) {
    ...
    player.records.thisRewind.maxEP = player.records.thisRewind.maxEP.max(value);
...
Currency.dilatedTime = new class extends DecimalCurrency {
  ...
  set value(value) {
    ...
    player.records.thisRewind.maxDT = player.records.thisRewind.maxDT.max(value);
  }
}();
...
Currency.realityMachines = new class extends DecimalCurrency {
  ...
  set value(value) {
    ...
    player.records.thisRewind.maxRM = player.records.thisRewind.maxRM.max(addedThisReality);
  }
}();
...
Currency.imaginaryMachines = new class extends NumberCurrency {
  ...
  set value(value) {
    ...
    player.records.thisRewind.maxIM = player.records.thisRewind.maxIM.max(Decimal.clampMax(value, MachineHandler.currentIMCap));
  }
}();
