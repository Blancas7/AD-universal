...
function giveRealityRewards(realityProps) {
  ...
  const realityAndPPMultiplier = multiplier.add(binomialDistribution(multiplier, Achievement(154).effectOrDefault(0))).times(player.celestialMultiplier);
