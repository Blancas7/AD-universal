export class PlayerProgress {
  ...
  get isRealityUnlocked() {
    return new Decimal(this._player.realities).gt(0) || this.isRewindUnlocked;
  }

  get isRewindUnlocked() {
    return new Decimal(this._player.rewinds).gt(0);
  }
  ...
  static hasBroken() {
    return player.break || this.isEternityUnlocked || this.isRealityUnlocked ||this.isRewindUnlocked;
  }
  ...
  static rewindUnlocked() {
    return PlayerProgress.current.isRewindUnlocked;
  }

  static seenAlteredSpeed() {
    const ec12 = EternityChallenge(12);
    return this.rewindUnlocked() || this.realityUnlocked() || ec12.completions > 0 || ec12.isRunning;
  }
