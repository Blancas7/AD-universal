export const awayProgressTypes = [
  {
    ...
    name: "blackHole",
    isUnlocked: () => BlackHole(1).isUnlocked || PlayerProgress.rewindUnlocked(),
    ...
    isUnlocked: () => BlackHole(2).isUnlocked || PlayerProgress.rewindUnlocked(),
    classObjectReference: "black-hole",
    showOption: false,
  }, {
    name: "relicShards",
    reference: ["celestials", "effarig", "relicShards"],
    isUnlocked: () => TeresaUnlocks.effarig.canBeApplied || PlayerProgress.rewindUnlocked(),
  }, {
    name: "celestialMemories",
    isUnlocked: () => VUnlocks.raUnlock.isUnlocked || PlayerProgress.rewindUnlocked(),
    ...
    isUnlocked: () => (Ra.pets.teresa.isUnlocked && !Ra.pets.teresa.isCapped) || PlayerProgress.rewindUnlocked(),
    showOption: false,
  }, {
    name: "effarigMemories",
    awayOption: "celestialMemories",
    reference: ["celestials", "ra", "pets", "effarig", "memories"],
    isUnlocked: () => (Ra.pets.effarig.isUnlocked && !Ra.pets.effarig.isCapped) || PlayerProgress.rewindUnlocked(),
    showOption: false,
  }, {
    ...
    isUnlocked: () => (Ra.pets.enslaved.isUnlocked && !Ra.pets.enslaved.isCapped) || PlayerProgress.rewindUnlocked(),
    showOption: false,
  }, {
    name: "vMemories",
    awayOption: "celestialMemories",
    reference: ["celestials", "ra", "pets", "v", "memories"],
    isUnlocked: () => (Ra.pets.v.isUnlocked && !Ra.pets.v.isCapped) || PlayerProgress.rewindUnlocked(),
    showOption: false,
  }, {
    name: "imaginaryMachines",
    reference: ["reality", "imaginaryMachines"],
    isUnlocked: () => MachineHandler.isIMUnlocked || PlayerProgress.rewindUnlocked(),
  }, {
    name: "darkMatter",
    reference: ["celestials", "laitela", "darkMatter"],
    isUnlocked: () => Laitela.isUnlocked || PlayerProgress.rewindUnlocked(),
  }, {
    name: "darkEnergy",
    ...
    isUnlocked: () => Pelle.isDoomed || PlayerProgress.rewindUnlocked(),
  },
];
