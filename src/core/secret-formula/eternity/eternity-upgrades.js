...
export const eternityUpgrades = {
  ...
  idMultEternities: {
    ...
    effect() {
      ...
      const eterPostCap = Currency.eternities.value.sub(1e5).max(0);
  ...
  tdMultRealTime: {
    ...
    description: () => (Pelle.isDoomed
      ...
      : "Time Dimensions are multiplied by days played in this Universe"
    ),
    effect: () => (Pelle.isDoomed ? 1 + Time.thisReality.totalDays : Math.max(Time.thisRewind.totalDays, 1)),
    formatEffect: value => formatX(value, 2, 1)
  }
};
