...
<br>
<br>
${PlayerProgress.rewindUnlocked() || PlayerProgress.realityUnlocked() || PlayerProgress.dilationUnlocked()
    ? "Dilation and any Dilation-like effects apply <i>after</i> all of these other effects are stacked together."
    : ""}
<br>
<br>
${PlayerProgress.rewindUnlocked() || PlayerProgress.realityUnlocked()
