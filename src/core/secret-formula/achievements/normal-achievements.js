...
export const normalAchievements = [
  ...
  },
  {
    ...
    get description() { return `Play for ${formatInt(1)} day.`; },
    checkRequirement: () => Time.totalTimePlayed.totalDays.gte(1),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    reward: "Extremely small multiplier to Antimatter Dimensions based on time played.",
    effect: () => Decimal.max(Decimal.pow(Time.thisRewind.totalDays.div(2), 0.05), 1),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 77,
  ...
  },
  {
    ...
    checkRequirement: () =>
      Currency.antimatter.gte("1e260000") &&
  ...
  },
  {
    id: 188,
    name: "The End",
    get description() { return `Reach ${formatInt(DC.BIMAX)} Antimatter.`; },
