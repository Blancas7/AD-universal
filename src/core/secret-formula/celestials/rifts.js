...
export const pelleRifts = {
  vacuum: {
    ...
    percentage: totalFill => Math.log10(totalFill.plus(1).log10().times(10).add(1).toNumber()) ** 2.5 / 100,
    ...
    milestones: [
      ...
      },
      {
        ...
        effect: () => Decimal.pow(4, PelleRifts.vacuum.totalFill.max(1).log10().div(2).div(308).add(3)),
  ...
  recursion: {
    ...
    effect: totalFill => new Decimal(totalFill.plus(1).log10().pow(0.2).times(58).div(4000 ** 0.2)),
  ...
  paradox: {
    ...
    effect: totalFill => new Decimal(totalFill.plus(1).log10().times(0.004).add(1)),
