export const tabs = [
  {
    ...
    subtabs: [
      ...
      {
        key: "stellar",
        name: "Stellar Dimensions",
        hideAt: 2.5,
        symbol: "☆",
        component: "StellarDimensionsTab",
  ...
  /*{
    ...
    subtabs: [
      ...
      //   symbol: "<i class='fas fa-arrow-up'></i>",
      //   component: "RewindUpgradesTab",
      //   id: 0,
      //   hidable: true,
      // },
      {
        key: "celestial-milestones",
        name: "Celestial milestones",
        symbol: "₪",
        component: "CelestialMilestonesTab",
        id: 1,
        hidable: true,
      },
      // {
