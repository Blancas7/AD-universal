...
export const infinityUpgrades = {
  totalTimeMult: {
    id: "timeMult",
    cost: 1,
    description: "Antimatter Dimensions gain a multiplier based on time played in this Universe",
    effect: () => Math.pow(Time.thisRewind.totalMinutes / 2, 0.15),
    formatEffect: value => formatX(value, 2, 2),
    charged: {
      description: "Antimatter Dimensions gain a power effect based on time played in this Universe and Teresa level",
      effect: () => 1 +
        Math.log10(Math.log10(Time.thisRewind.totalMilliseconds)) *
