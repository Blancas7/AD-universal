...
export const Time = {
  ...
  */
  get thisRewind() {
    return this.fromMilliseconds(() => player.records.thisRewind.time);
  },
  /**
   * @param {TimeSpan} timespan
   */
  set thisRewind(timespan) {
    this.toMilliseconds(timespan, value => player.records.thisRewind.time = value);
  },

  /**
   * @returns {TimeSpan}
   */
  get thisRewindRealTime() {
    return this.fromMilliseconds(() => player.records.thisRewind.realTime);
  },
  /**
   * @param {TimeSpan} timespan
   */
  set thisRewindRealTime(timespan) {
    this.toMilliseconds(timespan, value => player.records.thisRewind.realTime = value);
  },
   ...
   */
  get bestRewind() {
    return this.fromMilliseconds(() => player.records.bestRewind.time);
  },
  /**
   * @param {TimeSpan} timespan
   */
  set bestRewind(timespan) {
    this.toMilliseconds(timespan, value => player.records.bestRewind.time = value);
  },

  /**
   * @returns {TimeSpan}
   */
  get bestRewindRealTime() {
    return this.fromMilliseconds(() => player.records.bestRewind.realTime);
  },
  /**
   * @param {TimeSpan} timespan
   */
  set bestRewindRealTime(timespan) {
    this.toMilliseconds(timespan, value => player.records.bestRewind.realTime = value);
  },
