...
import { StellarDimensionAutobuyerState } from "./stellar-dimension-autobuyer";
...
export const Autobuyer = {
  ...
  stellarDimension: StellarDimensionAutobuyerState.createAccessor(),
...
export const Autobuyers = (function() {
  ...
  const stellarDimensions = Autobuyer.stellarDimension.zeroIndexed;

  const dimensions = [antimatterDimensions, infinityDimensions, timeDimensions, stellarDimensions];
...
EventHub.logic.on(GAME_EVENT.REWIND_RESET_AFTER, () => Autobuyers.reset());
...
EventHub.logic.on(GAME_EVENT.REWIND_RESET_AFTER, () => Autobuyers.resetTick(PRESTIGE_EVENT.REWIND));
