...
export const migrations = {
    ...
    if (player.autobuyers[11] % 1 !== 0) {
      ...
      switch (player.autoCrunchMode) {
        case "amount":
          ...
          break;
        case "time":
          autobuyer.time = condition.lt(DC.D_MAX_NUMBER) ? condition.toNumber() : autobuyer.time;
          break;
        case "relative":
  ...
  convertTimeTheoremPurchases(player) {
    ...
    player.timestudy.epBought = Decimal.round(new Decimal(player.timestudy.epcost).log2());
