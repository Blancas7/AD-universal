...
export const shortcuts = [
  {
    ...
    visible: () => PlayerProgress.rewindUnlocked() || PlayerProgress.realityUnlocked() || PlayerProgress.dilationUnlocked()
  }, {
    name: "Reality",
    keys: ["y"],
    type: "bindRepeatableHotkey",
    function: () => requestManualReality(),
    visible: () => PlayerProgress.rewindUnlocked() || PlayerProgress.realityUnlocked() || isRealityAvailable()
  }, {
    ...
    visible: () => PlayerProgress.rewindUnlocked() || PlayerProgress.realityUnlocked()
  }, {
